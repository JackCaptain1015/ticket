...
define(function(require, exports, module) {
	...
	(function() {
		var $ = {
			...
			/*
			 * modify by sky 2016-04-22 start
			 * 修改皮肤引入列表，太多的皮肤对性能有影响
			 */
			$skinList : [ {
				name : "default",
				charset : "gb2312"
            ...
            /* modify by sky 2016-04-22 end */
			$wdate : true,
			$crossFrame : true,
			$preLoad : false,
			$dpPath : "/static/plugin/My97DatePicker/",
		...
		function I(G, _) {
			...
			if (_ || G.eCont
					|| new RegExp(/input|textarea|div|span|p|a/ig).test(D))
